/*
 * Copyright (C) 2024 eYs3D Corporation
 * All rights reserved.
...
class CameraDeviceGeneral : public CameraDevice {
public:
    explicit CameraDeviceGeneral(DEVSELINFO *devSelInfo, DEVINFORMATION *deviceInfo);
    explicit CameraDeviceGeneral(DEVSELINFO *devSelInfo, DEVINFORMATION *deviceInfo, COLOR_BYTE_ORDER colorByteOrder);

    int initStream(libeYs3D::video::COLOR_RAW_DATA_TYPE colorFormat,
                   ...
                   libeYs3D::sensors::SensorDataProducer::AppCallback) override;

    ~CameraDeviceGeneral() override = default;
